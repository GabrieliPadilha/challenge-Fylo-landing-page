  ...
  <q-layout view="hHh lpR fff" class="bg-primary">
    ...
    <section class="header-content">
      ...
      <div style="text-align: center;">
        <h1 class="title">All your files in one secure location,<br/> accessible anywhere.</h1>
        <p class="paragraph">
    ...
    <section class="row options">
      ...
      >
        ...
        <h2 class="subtitles">Acess your files, anywhere</h2>
        <p>
          The abillity to use a smartphone, tablet or computer ,<br/>to access your account means your files follow you<br/> everywhere.
        </p>
      </div>
      <div
        class="col-md-6"
      >
        ...
        <h2 class="subtitles">Security you can trust</h2>
        <p>
      ...
      >
        ...
        <h2 class="subtitles">Real-time collaboration</h2>
        <p>
      ...
      >
        ...
        <h2 class="subtitles">Store any type of file</h2>
        <p>
